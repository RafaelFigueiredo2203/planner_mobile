  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      ...
      <Text className='text-zinc-500 font-regular text-center text-base'>
        Ao planejar sua viagem com a plann.er você concorda
        automaticamente com nossos {" "} <Text className="text-zinc-300 underline"> termos de uso e políticas de privacidade.</Text>
      </Text>
    </View>
  )
}
